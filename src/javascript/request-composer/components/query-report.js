...
export default class QueryReport extends React.Component {
   ...
   */
  reportLink() {
    let params = (this.props.includeViewId) ?
        this.props.report.params : omit(this.props.report.params, 'viewId');
            ...
            <div className="FormControl-body">
              ...
              <label className="FormControl-info">
                <input
                  className="Checkbox"
                  type="checkbox"
                  onChange={this.props.onViewIdToggle}
                  checked={this.props.includeViewId} />
                  Include <code>viewId</code> parameter in the link above
