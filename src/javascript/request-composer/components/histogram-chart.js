...
const FILL_COLOR = ['rgba(250,137,79,0.5)',
  'rgba(179,191,205,0.5)',
  'rgba(240,206,147,0.5)',
  'rgba(74,86,109,0.5)',
  'rgba(108,128,167,0.5)'];
const STROKE_COLOR = ['rgba(250,137,79,0.8)',
  'rgba(179,191,205,0.8)',
  'rgba(240,206,147,0.5)',
  'rgba(74,86,109,0.8)',
  'rgba(108,128,167,0.8)'];
const HIGHLIGHT_FILL = ['rgba(250,137,79,0.75)',
  'rgba(179,191,205,0.75)',
  'rgba(240,206,147,0.5)',
  'rgba(74,86,109,0.75)',
  'rgba(108,128,167,0.75)'];
const HIGHLIGHT_STROKE = ['rgba(250,137,79,1)',
  'rgba(179,191,205,1)',
  'rgba(240,206,147,0.5)',
  'rgba(74,86,109,1)',
  'rgba(108,128,167,1)'];
...
export function createChartData(report) {
  ...
  if (report.data.rows && report.data.rows.length) {
    ...
    for (let j=0, row; row = report.data.rows[j]; ++j) {
      const metricValues = row.metrics[0].values;
...
export default class HistogramChart extends React.Component {
  ...
  render() {
    ...
    const data = createChartData(response.result.reports[0]);
