...
var AccountSummaries = __webpack_require__(1);
  ...
  return new promise.constructor(function (resolve, reject) {
    ...
    promise.then(function fn(resp) {
      ...
      if (result.items) {
        ...
        reject(new Error('You do not have any Google Analytics accounts. ' + 'Go to http://google.com/analytics to sign up.'));
      }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_javascript_api_utils_lib_account_summaries__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_javascript_api_utils_lib_account_summaries___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_javascript_api_utils_lib_account_summaries__);
  ...
  gapi.analytics.createComponent('ViewSelector2', {
    ...
    setup_: function setup_(cb) {
      ...
      var onAuthorize = function onAuthorize() {
        __WEBPACK_IMPORTED_MODULE_0_javascript_api_utils_lib_account_summaries___default.a.get().then(function (summaries) {
