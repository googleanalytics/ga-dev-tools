...
const TagAssistant = () => {
  return <Layout title="Tag Assistant">
    ...
    troubleshoot common problems. It's an ideal tool for debugging and testing 
    your analytics.js implementations locally and ensuring everything is correct
     before deploying your code to production.
    </Typography>

    <Typography variant="body1">
    Tag Assistant works by letting you record a typical user flow. It keeps 
    track of all the hits you send, checks them for any problems, and gives you 
    a full report of the interactions. If it detects any issues or potential 
    ...
    <Typography variant="body1" component="ul">
      <li><a href={Url.protocolParameters}>Measurement Protocol parameter reference</a></li>
      <li><a href={Url.crossDomainTracking}>Cross-domain Linker plugin</a></li>
    </Typography>

    <Typography variant="h2">Learn More</Typography>

    <Typography variant="body1">
    To learn more about Tag Assistant and using Tag Assistant Recordings, you can read about them in the Google Analytics Help Center:
    </Typography>

    <Typography variant="body1" component="ul">
      <li><a href={Url.aboutTagAssistant}>About Tag Assistant</a></li>
      <li><a href={Url.aboutTagAssistantRecordings}>About Tag Assistant Recordings</a></li>
    </Typography>
