...
const useHash = (): string => {
  // todo - Pretty sure there's a location related hook provided by gatsby.
  // Also, this is something that maybe should be an external dep?
  return "hi"
}
...
export const AutoScrollProvider: React.FC<{
  ...
  const observeScrollableNode = React.useCallback(
    ...
    [navTarget, didNav, setDidNav, behavior, block]
  )
