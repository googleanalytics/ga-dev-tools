...
export const ensureFirebaseLoginStatus = async ({ noLocalhost }) => {
...
export const ensureFirebaseFunctionsConfig = async (environment, config) => {
...
export const deployFunctions = async args => {
