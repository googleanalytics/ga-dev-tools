...
exports.writeEnvFile = async (config) => {
    ...
    [types_1.DotEnvProductionPath, types_1.DotEnvDevelopmentPath].map(path => fs.writeFileSync(path, [gapiLine, bitlyLine, authEndpointLine].join("\n"), {
...
const configQuestions = (filter) => {
    ...
    return [
        ...
        // Staging questions
        {
            ...
            default: ((_f = filter === null || filter === void 0 ? void 0 : filter.staging) === null || _f === void 0 ? void 0 : _f.baseUri) || exports.SKIP_QUESTION,
            when: () => {
                var _a;
        ...
        },
        {
            ...
            // TODO - See if listing is useful. Probably should only do it if there's not a ton.
            default: ((_g = filter === null || filter === void 0 ? void 0 : filter.staging) === null || _g === void 0 ? void 0 : _g.firebaseProjectId) || exports.SKIP_QUESTION,
            when: () => {
                var _a;
        ...
        },
        {
            ...
            default: ((_h = filter === null || filter === void 0 ? void 0 : filter.staging) === null || _h === void 0 ? void 0 : _h.gapiClientId) || exports.SKIP_QUESTION,
            when: () => {
                var _a;
        ...
        },
        {
            ...
            default: ((_j = filter === null || filter === void 0 ? void 0 : filter.staging) === null || _j === void 0 ? void 0 : _j.bitlyClientId) || exports.SKIP_QUESTION,
            when: () => {
                var _a;
        ...
        },
        {
            ...
            default: ((_k = filter === null || filter === void 0 ? void 0 : filter.staging) === null || _k === void 0 ? void 0 : _k.bitlyClientSecret) || exports.SKIP_QUESTION,
            when: () => {
                var _a;
